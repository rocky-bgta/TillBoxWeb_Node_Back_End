...
export default class Utils {
    ...
    static insertDataIntoFixedTable(givenPath:string) {
        console.info(givenPath);
        //joining path of directory
        //var directoryPath= path.parse(givenPath)
        //var directoryPath = path.join(__dirname, 'fixedSql');
        //passsing directoryPath and callback function
        fs.readdir(givenPath, (err: any, files: any) => {
            //handling error
            if (err) {
            ...
            files.forEach((file: any) => {
                //readFile(givenPath)
                var filePath = path.resolve(givenPath,file).toString();
