...
import startUpModuleControllers from './controllers/startUp';
import accountModuleControllers from './controllers/accounting'
...
export class ApiServer {
    ...
    constructor() {
        ...
        Server.buildServices(this.app,
            ...
            ...accountModuleControllers);

        //Swagger generation
        Server.loadServices(this.app,'/controllers/startUp', __dirname);
        Server.loadServices(this.app,'/controllers/accounting', __dirname);
